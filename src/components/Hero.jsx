  ...
  return (
    <div className="flex items-center">
      <div className="max-w-screen-2xl w-full mx-auto text-white">
        <img className="absolute w-36 md:w-72 -translate-y-11 sm:-translate-y-20 translate-x-[70%] sm:translate-x-[240%] " src={MainLogo} alt="mainlogo"/>
        ...
        <button className=" flex py-1 sm:py-4 px-4 sm:px-16 font-medium sm:font-bold rounded-md bg-gradient-to-l from-[#8c52ff] to-[#341671] hover:from-[#7641de]">About Me <FaArrowRightLong className=" ml-[5rem] lg:ml-32 absolute"/></button>
        </div>
