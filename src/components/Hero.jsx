  ...
  return (
    <div className="flex items-center">
      <div className="max-w-screen-2xl w-[70%] mx-auto text-white">
        ...
        <h1 className=" font-bold text-5xl sm:text-7xl md:text-9xl ">Sou<span className="text-[#8c52ff]">a</span>mya</h1>
        <p className="italic my-5 mb-9 text-xs sm:text-xl md:text-2xl " >MERN <span className="text-[#8c52ff]">Stack</span> Developer</p>
        <button onClick={() => setAboutMe(!aboutMe)} className=" translate-y-12 sm:translate-y-0 flex py-1 sm:py-2 px-2 sm:px-11 font-medium sm:font-bold rounded-md bg-gradient-to-l from-[#8c52ff] to-[#341671] hover:scale-110 duration-150 group">About Me <FaArrowRightLong className=" text-white size-6 ml-[5rem] lg:ml-28 absolute group-hover:-right-6 ease-in-out duration-150 "/></button>
        </div>
        {aboutMe && (<AboutMePop/>)}
      </div >
